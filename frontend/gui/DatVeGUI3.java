	...
	public class DatVeGUI3 extends JPanel {
		...
		private JPanel buildLeftPanel() {
			...
			btnGhiChu.addActionListener(e -> {
			    ...
			    if (input != null) ghiChu = input.trim();
			});
		...
		private void taoHoaDonPDF(String hinhThuc) {
			try {
				...
				String ghiChuHienThi = (ghiChu != null && !ghiChu.isEmpty())
				        ? ghiChu
				        : "......................................................................................................................................";
		...
		private boolean luuDuLieuVaoDatabase(String hinhThucThanhToan) {
		    ...
		    try {
		        ...
		        boolean isKhuHoi = modelFromGUI2.getRowCount() > 0
		                && modelFromGUI2.getValueAt(0, 2).toString()
		                                .toLowerCase().contains("hồi");

		        boolean veOk = new dao.VeDAO()
