...
public final class ThongKeGUI extends JPanel {
    ...
    private JPanel buildTablePanel() {
        ...
        // --- KHÓA TÙY CHỈNH CỘT Ở ĐÂY ---
        tblData.getTableHeader().setReorderingAllowed(false); // Không cho kéo đổi vị trí cột
        tblData.getTableHeader().setResizingAllowed(false);   // Không cho kéo rộng/hẹp cột
        // -------------------------------
...
// ChartPanel và các logic khác giữ nguyên...
