...
final class KhachHangGUI extends JPanel {
    ...
    private JPanel buildFilterPanel() {
        ...
        lblTitle.setIcon(GuiIcons.loadIcon(KhachHangGUI.class, "/Images/traCuu.png", 16, 16));
    ...
    private JPanel buildTablePanel() {
        ...
        lblTitle.setFont(GuiTheme.font("Segoe UI", Font.BOLD, 15));
        lblTitle.setForeground(GuiTheme.NAVY);
        lblTitle.setIcon(GuiIcons.loadIcon(KhachHangGUI.class, "/Images/DanhSach.png", 16, 16));
        lblTitle.setIconTextGap(8);
